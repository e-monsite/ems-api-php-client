...
class PageCategory 
{
	...
	/**
	 * PageCategory resource class constructor
	 * 
	...
	/**
	 * Site module Pages page category version list
	 * 
	 ...
	 * 
	 * @return PageCategoryVersionListResponse
	 * 
	 * @throws UnexpectedResponseException
	 */
	public function getPageCategoryVersions($include = null, $search = null, $page = null, $limit = null, $order_by = null)
	{
		$routePath = '/api/site/{siteId}/module/pages/category/page/{pageCategoryId}/version';

		$pathReplacements = [
			'{siteId}' => $this->site_id,
			'{pageCategoryId}' => $this->id,
		];
		...
		$response = new PageCategoryVersionListResponse(
			$this->apiClient, 
			array_map(function($data) {
				return new PageCategoryVersion(
					$this->apiClient, 
					$data['item_id'], 
					$data['lang'], 
					$data['name'], 
	...
	/**
	 * Site module Pages page category page list
	 * 
	...
	{
		$routePath = '/api/site/{siteId}/module/pages/category/page/{pageCategoryId}/page';
	...
	/**
	 * Site module Pages page category page category list
	 * 
	 * Excepted HTTP code : 200
	 * 
	 * @param string $include Include responses : {include1},{include2,{include3}[...]
	...
	{
		$routePath = '/api/site/{siteId}/module/pages/category/page/{pageCategoryId}/category';
