...
use Emonsite\Api\Resources\UserListResponse;
...
class UserManager 
{
		...
		$response = new UserListResponse(
			...
			array_map(function($data) {
				return new User(
					$this->apiClient, 
					$data['id'], 
					(isset($data['emonsite_user_id']) ? $data['emonsite_user_id'] : null), 
					$data['user_group_id'], 
					$data['name'], 
					$data['email'], 
	 ...
	 * @throws UnexpectedResponseException
	 */
	public function update($userId, $user_group_id, $name, $email, $password, $emonsite_user_id = null, $preferred_language = null)
	{
		$routePath = '/api/user/{userId}';
